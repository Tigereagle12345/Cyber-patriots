...
echo -e '\nalias cypat-clamav="cd ~ && bash $user_home/Cyber-patriots/ubuntu/main/support/clamav.sh"' >> "$home_dir"
echo -e '\nalias cypat-search="cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/search.sh"' >> "$home_dir"
echo -e '\nalias cypat-man="cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/man.sh"' >> "$home_dir"
echo -e '\nalias cypat-uid="cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/uid.sh"' >> "$home_dir"

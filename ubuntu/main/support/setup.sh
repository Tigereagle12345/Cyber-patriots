...
echo -e "alias cypat-search='cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/search.sh'" >> "$home_dir"
echo -e "alias cypat-man='cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/man.sh'" >> "$home_dir"
echo -e "alias cypat-uid='cd ~ && bash $user_home/Cyber-patriots/ubuntu/extraCMDs/uid.sh'" >> "$home_dir"
